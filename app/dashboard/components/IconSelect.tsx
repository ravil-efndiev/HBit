...
const IconSelect = ({ top, left, initialIconPath, selectClasses, onSelect }: Props) => {
  ...
  return (
    <>
      <ModalWrapper dialogRef={iconSelectRef} top={top || "54vh"} left={left} width={450}>
      ...
      <div
        className={`select w-20 cursor-pointer mb-3 shadow-sm ${selectClasses}`}
